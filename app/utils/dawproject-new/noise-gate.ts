...
/**
 * Represents a noise gate device.
 * Corresponds to the 'noiseGate' complex type in Project.xsd.
 * Inherits attributes and child elements from BuiltinDevice.
 */
export class NoiseGate extends BuiltinDevice implements NoiseGateType {
  // Properties corresponding to child elements

  /**
   * The attack parameter for the noise gate.
   * (Optional child element)
   */
  public Attack?: RealParameter;

  /**
   * The range parameter for the noise gate.
   * (Optional child element)
   */
  public Range?: RealParameter;

  /**
   * The ratio parameter for the noise gate.
   * (Optional child element)
   */
  public Ratio?: RealParameter;

  /**
   * The release parameter for the noise gate.
   * (Optional child element)
   */
  public Release?: RealParameter;

  /**
   * The threshold parameter for the noise gate.
   * (Optional child element)
   */
   ...
   * @param name - The name of the noise gate. (Optional attribute inherited from Nameable)
   * @param color - The color of the noise gate. (Optional attribute inherited from Nameable)
   * @param comment - A comment for the noise gate. (Optional attribute inherited from Nameable)
