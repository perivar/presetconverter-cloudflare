...
import type {
  DeviceRole,
  Vst3Plugin as Vst3PluginType,
  XsBoolean,
  XsString,
} from "./project-schema";

/**
 * Represents a VST3 plugin device.
 * Corresponds to the 'vst3Plugin' complex type in Project.xsd.
 * Inherits attributes and child elements from Plugin.
 */
export class Vst3Plugin extends Plugin implements Vst3PluginType {
  // Note: The XSD does not define additional attributes or child elements for vst3Plugin.
  // Inherits attributes and child elements from Plugin.
