 ...
 * Corresponds to the 'clapPlugin' complex type in Project.xsd.
 * Inherits attributes and child elements from Plugin.
 */
export class ClapPlugin extends Plugin implements ClapPluginType {
  // ClapPlugin type in Project.xsd doesn't add new properties beyond Plugin.
  // Inherits attributes and child elements from Plugin.
