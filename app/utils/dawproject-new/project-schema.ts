...
export type ArrangementElement = Prolog & {
  Arrangement?: Many<unknown>;
};

export type AuPluginElement = Prolog & {
  AuPlugin?: Many<unknown>;
};

export type AudioElement = Prolog & {
  Audio?: Many<unknown>;
};

export type BoolParameterElement = Prolog & {
  BoolParameter?: Many<unknown>;
};

export type BoolPointElement = Prolog & {
  BoolPoint?: Many<unknown>;
};

export type BuiltinDeviceElement = Prolog & {
  BuiltinDevice?: Many<unknown>;
};

export type ChannelElement = Prolog & {
  Channel?: Many<unknown>;
};

export type ClapPluginElement = Prolog & {
  ClapPlugin?: Many<unknown>;
};

export type ClipElement = Prolog & {
  Clip?: Many<unknown>;
};

export type ClipSlotElement = Prolog & {
  ClipSlot?: Many<unknown>;
};

export type ClipsElement = Prolog & {
  Clips?: Many<unknown>;
};

export type CompressorElement = Prolog & {
  Compressor?: Many<unknown>;
};

export type DeviceElement = Prolog & {
  Device?: Many<unknown>;
};

export type EnumParameterElement = Prolog & {
  EnumParameter?: Many<unknown>;
};

export type EnumPointElement = Prolog & {
  EnumPoint?: Many<unknown>;
};

export type EqualizerElement = Prolog & {
  Equalizer?: Many<unknown>;
};

export type IntegerParameterElement = Prolog & {
  IntegerParameter?: Many<unknown>;
};

export type IntegerPointElement = Prolog & {
  IntegerPoint?: Many<unknown>;
};

export type LanesElement = Prolog & {
  Lanes?: Many<unknown>;
};

export type LimiterElement = Prolog & {
  Limiter?: Many<unknown>;
};

export type MarkerElement = Prolog & {
  Marker?: Many<unknown>;
};

export type NoiseGateElement = Prolog & {
  NoiseGate?: Many<unknown>;
};

export type NoteElement = Prolog & {
  Note?: Many<unknown>;
};

export type NotesElement = Prolog & {
  Notes?: Many<unknown>;
};

export type PointElement = Prolog & {
  Point?: Many<unknown>;
};

export type PointsElement = Prolog & {
  Points?: Many<unknown>;
};

export type ProjectElement = Prolog & {
  Project?: Many<unknown>;
};

export type RealParameterElement = Prolog & {
  RealParameter?: Many<unknown>;
};

export type RealPointElement = Prolog & {
  RealPoint?: Many<unknown>;
};

export type SceneElement = Prolog & {
  Scene?: Many<unknown>;
};

export type TimeSignatureParameterElement = Prolog & {
  TimeSignatureParameter?: Many<unknown>;
};

export type TimeSignaturePointElement = Prolog & {
  TimeSignaturePoint?: Many<unknown>;
};

export type TimelineElement = Prolog & {
  Timeline?: Many<unknown>;
};

export type TrackElement = Prolog & {
  Track?: Many<unknown>;
};

export type VideoElement = Prolog & {
  Video?: Many<unknown>;
};

export type Vst2PluginElement = Prolog & {
  Vst2Plugin?: Many<unknown>;
};

export type Vst3PluginElement = Prolog & {
  Vst3Plugin?: Many<unknown>;
};

export type WarpElement = Prolog & {
  Warp?: Many<unknown>;
};

export type WarpsElement = Prolog & {
  Warps?: Many<unknown>;
};

export type MarkersElement = Prolog & {
  markers?: Many<unknown>;
};

export type ParameterElement = Prolog & {
  parameter?: Many<unknown>;
};
