...
export function convertFabFilterProQBaseToSteinbergFrequency(
  ...
  const frequency = new SteinbergFrequency(version);
...
export const FabFilterProQBaseToSteinbergFrequency: MultiFormatConverter<
  FabFilterProQBase,
  SteinbergFrequency
> = {
  ...
  convertBase(eq: FabFilterProQBase) {
    return convertFabFilterProQBaseToSteinbergFrequency(eq, 1);
  },
